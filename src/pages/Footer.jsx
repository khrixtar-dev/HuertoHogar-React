...
import { esAdmin } from '../../public/js/persistenciaLogin';
...
function Footer() {
  ...
  useEffect(() => {
    actualizarAdmin();
    window.addEventListener('sesionActualizada', actualizarAdmin);
    
    return () => {
      window.removeEventListener('sesionActualizada', actualizarAdmin);
    };
  }, []);
  ...
  return (
    <>
      {adminActivo ? (
        ...
        <footer className="custom-footer footer-admin">
