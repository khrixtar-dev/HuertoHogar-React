...
import { cuentaIniciada, obtenerUsuarioActual, cerrarSesion, esAdmin } from '../../public/js/persistenciaLogin';
            ...
            <Container>
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="ms-auto">
                  <Nav.Link as={Link} to="/admin-usuarios" translate="no">Admin Usuarios</Nav.Link>
                  <Nav.Link as={Link} to="/admin-productos" translate="no">Admin Productos</Nav.Link>
                  <NavDropdown title={usuario?.nombre || 'Administrador'} id="admin-dropdown">
